...
public function __construct($name, $DOB, $age, $Address, $email, $phone_No, $id_no, $id_proof, $reg)
{
    $this -> name = $name;
    $this -> DOB = $DOB;
    $this -> age = $age;
...
public function SignUpUser()
{
    ...
    $this-> setuser($this-> name, $this-> DOB, $this-> age, $this-> Address, $this-> email, $this-> phone_No, $this-> id_no, $this-> id_proof, $this-> reg);
}
